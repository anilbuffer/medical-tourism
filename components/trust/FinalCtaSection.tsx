    ...
    <section className="py-24 bg-gradient-to-b from-[#061019] via-[#0B1E33] to-[#040A10] text-white relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <button
            onClick={() => openIntake()}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-9 py-4 rounded-xl text-base font-bold text-white  bg-gradient-to-r from-[#1d8983] via-[#1baba4] to-[#1d8983] shadow-2xl shadow-[#283593]/30 hover:scale-[1.02] active:scale-[0.98] transition-all group"
          >
