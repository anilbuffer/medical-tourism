      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {perks.map((perk, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white/5 backdrop-blur-md rounded-3xl p-7 border border-white/10 hover:border-teal-400/50 hover:bg-white/10 transition-all duration-300 group flex flex-col justify-between"
              >
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-teal-500/20 border border-teal-400/30 flex items-center justify-center text-teal-300 mb-5 group-hover:scale-110 group-hover:bg-teal-500 group-hover:text-slate-950 transition-all">
                ...
                <div className="pt-6 mt-4 border-t border-white/10 flex items-center gap-1.5 text-[11px] font-semibold text-teal-400">
        ...
        <div className="text-center">
          <button
            ...
            className="inline-flex items-center gap-3 px-8 py-4 rounded-xl text-sm font-bold text-slate-950 bg-gradient-to-r from-teal-300 via-teal-200 to-emerald-300 hover:from-teal-200 hover:to-emerald-200 shadow-xl shadow-teal-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
          >
