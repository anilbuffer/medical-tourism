          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-400">
              ...
              <div className="pt-2">
                <a
                  href="/#assessment"
                  className="block w-full py-2.5 px-3 rounded-xl bg-gradient-to-r from-[#2ECDC5] via-[#2ECDC5] to-[#2abdb5] hover:from-[#283593] hover:to-[#2ECDC5] text-white font-bold text-xs shadow-md shadow-[#283593]/30 transition-all text-center"
                >
                  {t.nav.startJourney}
                </a>
              </div>
