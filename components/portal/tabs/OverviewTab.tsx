    ...
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#071321] via-[#0B1E33] to-[#0D2642] rounded-3xl p-6 text-white shadow-xl border border-slate-800/80 space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-[#2ECDC5] via-[#3F4EB4] to-[#283593] hover:from-[#283593] hover:to-[#2ECDC5] text-white font-extrabold text-xs shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-[#2ECDC5] via-[#3F4EB4] to-[#283593] hover:from-[#283593] hover:to-[#2ECDC5] text-white font-bold text-xs shadow-xl shadow-[#283593]/35 hover:scale-105 active:scale-95 transition-all cursor-pointer"
        >
