...
export const OverviewTab: React.FC<OverviewTabProps> = ({ patientCase, onNavigateTab }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
      ...
      <div className="bg-gradient-to-r from-[#071321] via-[#0B1E33] to-[#0D2642] rounded-3xl p-6 sm:p-7 text-white shadow-xl border border-slate-800/80 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        {/* Glow accents */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#071321] via-[#0B1E33] to-[#0D2642] rounded-3xl p-6 text-white shadow-xl border border-slate-800/80 space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-[#2ECDC5] via-[#2ECDC5] to-[#2abdb5] hover:from-[#283593] hover:to-[#2ECDC5] text-white font-extrabold text-xs shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
            >
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-[#2ECDC5] via-[#2ECDC5] to-[#2abdb5] hover:from-[#283593] hover:to-[#2ECDC5] text-white font-bold text-xs shadow-xl shadow-[#283593]/35 hover:scale-105 active:scale-95 transition-all cursor-pointer"
        >
            ...
            {feedbackSubmitted ? (
              ...
              <form onSubmit={handleSendFeedback} className="space-y-3">
                ...
                <div className="flex items-center justify-end gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2 rounded-xl bg-gradient-to-r from-[#2ECDC5] via-[#2ECDC5] to-[#2abdb5] hover:from-[#283593] hover:to-[#2ECDC5] text-white text-xs font-bold shadow-md shadow-[#283593]/30 flex items-center gap-1.5"
                  >
