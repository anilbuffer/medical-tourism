...
export const OverviewTab: React.FC<OverviewTabProps> = ({ patientCase, onNavigateTab }) => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
            Good morning, <span className="bg-gradient-to-r from-[#2ECDC5] via-[#3F4EB4] to-[#283593] bg-clip-text text-transparent font-black">{firstName}</span>
          </h1>
      ...
      <div className="bg-gradient-to-br from-[#071321] via-[#0B1E33] to-[#0D2642] rounded-3xl p-6 sm:p-7 text-white shadow-2xl border border-slate-800/80 relative overflow-hidden">
        {/* Ambient Cyan & Indigo glow matching Homepage */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#2ECDC5]/15 rounded-full blur-3xl pointer-events-none -mr-20 -mt-20" />
        <div className="absolute bottom-0 left-10 w-80 h-80 bg-[#3F4EB4]/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between">
          <div className="inline-flex items-center gap-3 bg-white/10 px-4 py-2.5 rounded-2xl border border-white/10 backdrop-blur-sm">
            <div className="relative w-9 h-9 rounded-full bg-gradient-to-br from-[#2ECDC5] via-[#3F4EB4] to-[#283593] ring-1 ring-[#2ECDC5]/40 flex items-center justify-center font-bold text-white text-sm">
              <span>S</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div
          ...
          className="bg-white/95 backdrop-blur-xl rounded-2xl p-5 border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:border-[#2ECDC5]/50 transition-all duration-300 flex items-center justify-between cursor-pointer group"
        >
        ...
        >
          <div className="flex items-center gap-3.5">
            <div className="w-11 h-11 rounded-2xl bg-[#2ECDC5]/10 text-[#3F4EB4] border border-[#2ECDC5]/20 flex items-center justify-center shrink-0">
              <DollarSign className="w-5 h-5 text-[#3F4EB4]" />
            </div>
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-3">
            {activityFeed.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="bg-white/95 backdrop-blur-xl rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:border-slate-300 transition-all duration-300"
                >
        ...
        <div className="space-y-6">
          {/* Upcoming Section */}
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-5 sm:p-6 border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] transition-all duration-300 space-y-4">
            <div className="flex items-center justify-between pb-1 border-b border-slate-100">
              <h2 className="text-base font-extrabold text-slate-900">Upcoming</h2>
              <button
                onClick={() => onNavigateTab("consultation")}
                className="text-[#3F4EB4] hover:text-[#283593]"
            ...
            <div className="space-y-4">
              {/* Event 1 */}
              <div className="p-3.5 bg-slate-50/70 rounded-2xl border border-slate-100 space-y-2 hover:bg-slate-50 transition-colors">
                ...
                <div className="flex items-center gap-2 pt-1">
                  <div className="w-6 h-6 rounded-full bg-[#2ECDC5]/15 text-[#3F4EB4] text-[10px] font-bold flex items-center justify-center">
                    S
                  </div>
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl p-5 sm:p-6 border border-slate-200 shadow-[0_6px_32px_rgba(0,0,0,0.06)] hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] transition-all duration-300 space-y-4">
            ...
            <div className="flex items-center justify-between p-3.5 bg-slate-50/70 rounded-2xl border border-slate-100 hover:bg-slate-50 transition-colors">
              <div className="flex items-center gap-3">
                <div className="relative w-10 h-10 rounded-full bg-[#2ECDC5]/15 text-[#3F4EB4] font-bold flex items-center justify-center text-sm ring-1 ring-[#2ECDC5]/30">
                  <span>S</span>
