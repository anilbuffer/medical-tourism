...
export const DOCTORS: Doctor[] = [
  {
    ...
    experienceYears: 19,
    hospital: "Meridian Heart Institute",
    hospitalAr: "معهد ميريديان للقلب",
    city: "New Delhi",
    cityAr: "نيودلهي",
    rating: 4.98,
    reviewsCount: 380,
    languages: ["English", "Hindi", "Arabic (Conversational)"],
    languagesAr: ["الإنجليزية", "الهندية", "العربية (محادثة)"],
    ...
    bio: "Over 14,000 successful coronary and structural heart interventions. Specialized in complex bifurcation stenting, TAVI, and minimally invasive valve restoration for high-risk international patients.",
    bioAr: "أكثر من 14,000 قسطرة وتدخل علاجي للقلب. متخصص في القسطرة المعقدة للشرايين التاجية وزراعة الصمام الأورطي عبر القسطرة (TAVI) للمرضى الدوليين.",
  ...
  },
  {
    ...
    experienceYears: 22,
    hospital: "Asteria Cancer Centre",
    hospitalAr: "مركز أستيريا للسرطان",
    city: "Mumbai",
    cityAr: "مومباي",
    rating: 4.96,
    reviewsCount: 420,
    languages: ["English", "Hindi", "Malayalam", "Arabic (Basic)"],
    languagesAr: ["الإنجليزية", "الهندية", "المالايالامية", "العربية"],
    avatar: "https://images.unsplash.com/photo-1594824813596-78cb97da7e31?auto=format&fit=crop&q=80&w=600",
    education: "MBBS, MD, DNB (Medical Oncology) — Tata Memorial Hospital",
    ...
    bio: "International authority on precision molecular oncology, targeted immunotherapy, and genetic profiling for advanced breast, lung, and gastrointestinal cancers.",
    bioAr: "مرجع دولي معتمد في العلاج المناعي الموجه والفحوصات الجينية المتقدمة لأورام الثدي والرئة والجهاز الهضمي مع خطط علاجية مخصصة.",
  ...
  },
  {
    ...
    experienceYears: 17,
    hospital: "NovaCare Institute",
    hospitalAr: "معهد نوفاكير الطبي",
    city: "Gurugram / Delhi NCR",
    cityAr: "جوروجرام / دلهي",
    rating: 4.95,
    reviewsCount: 310,
    ...
    education: "MBBS, MS (Ortho), M.Ch (Ortho) — UK",
    ...
    bio: "Pioneer in robotic sub-millimeter knee alignment and kinematic muscle-sparing joint replacements enabling same-day ambulation for global patients.",
    bioAr: "رائد في تقنيات محاذاة الركبة بالروبوت واستبدال المفاصل بالحفاظ على العضلات مما يتيح للمريض المشي في نفس يوم الجراحة.",
  ...
  },
  {
    ...
    experienceYears: 20,
    hospital: "Apex Multi-Specialty Health City",
    hospitalAr: "مدينة أبكس الطبية متعددة التخصصات",
    city: "Chennai",
    cityAr: "تشيناي",
    rating: 4.99,
    reviewsCount: 510,
    languages: ["English", "Arabic (Fluent)", "Hindi", "Bengali"],
    languagesAr: ["الإنجليزية", "العربية (بطلاقة)", "الهندية", "البنغالية"],
    ...
    bio: "Fluent Arabic speaker with over 2,200 living donor liver and kidney transplants. Regularly leads transplant care for dignitaries and families from the GCC and North Africa.",
    bioAr: "تتحدث العربية بطلاقة وأجرت أكثر من 2200 عملية زراعة كبد وكلى ناجحة. تشرف باستمرار على علاج المرضى القادمين من دول الخليج والشرق الأوسط.",
...
export const HOSPITALS: Hospital[] = [
  {
    ...
    nameAr: "معهد ميريديان للقلب والأوعية",
    city: "New Delhi",
    cityAr: "نيودلهي",
    state: "Delhi NCR",
    specialties: ["Cardiac Sciences", "Vascular Surgery", "Heart Transplant", "Pediatric Cardiology"],
    specialtiesAr: ["علوم القلب", "جراحة الأوعية", "زراعة القلب", "قلب الأطفال"],
    ...
    description: "Flagship dedicated tertiary cardiac institute in the capital city featuring 7 hybrid cath labs, robotic surgical suites, and a dedicated 24/7 International Patient Lounge with prayer rooms and halal dining.",
    descriptionAr: "معهد تخصصي رائد في قلب العاصمة يضم 7 غرف قسطرة هجينة، وأجنحة جراحة روبوتية، وصالة استقبال دولية لكبار الشخصيات مع مطبخ حلال وغرف للصلاة.",
    internationalLounge: true,
    airportDistance: "25 Mins from IGI Airport T3",
    featured: true,
  },
  {
    id: "asteria-cancer",
    name: "Asteria Comprehensive Cancer Centre",
    nameAr: "مركز أستيريا الشامل لعلاج السرطان",
    city: "Mumbai",
    cityAr: "مومباي",
    state: "Maharashtra",
    specialties: ["Medical Oncology", "Proton Beam Radiation", "Surgical Oncology", "BMT Unit"],
    specialtiesAr: ["طب الأورام", "العلاج بالبروتون", "جراحة الأورام", "زراعة نخاع العظم"],
    accreditations: ["JCI Accredited", "NABH Certified", "NABL Laboratory"],
    bedsCount: 520,
    surgeonsCount: 65,
    image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&q=80&w=800",
    description: "South Asia's leading precision oncology pavilion equipped with South Asia's first compact Proton Beam Therapy system and CyberKnife VSI radiosurgery.",
    descriptionAr: "أحد أحدث مراكز علاج الأورام الدقيقة في آسيا مزود بأول نظام للعلاج الإشعاعي بالبروتون وجهاز السايبر نايف للأورام المستعصية.",
    internationalLounge: true,
    airportDistance: "15 Mins from Chhatrapati Shivaji Int'l Airport",
    featured: true,
  },
  {
    id: "novacare-institute",
    name: "NovaCare Institute of Medical Sciences",
    nameAr: "معهد نوفاكير للعلوم الطبية المتطورة",
    city: "Bengaluru",
    cityAr: "بنغالورو",
    state: "Karnataka",
    specialties: ["Robotic Orthopedics", "Neurosciences", "Robotic Spine", "Organ Transplants"],
    specialtiesAr: ["جراحة العظام بالروبوت", "جراحة الأعصاب", "العمود الفقري", "زراعة الأعضاء"],
    accreditations: ["NABH Accredited", "JCI Gold Seal", "ISO 9001:2015"],
    bedsCount: 680,
    surgeonsCount: 82,
    image: "https://images.unsplash.com/photo-1586773860418-d37222d8fce3?auto=format&fit=crop&q=80&w=800",
    description: "Silicon Valley of India's most technically advanced quaternary hospital campus boasting 4 Da Vinci Xi surgical robots and dedicated neuro-navigation ICU suites.",
    descriptionAr: "المجمع الطبي الأحدث تقنياً في بنغالورو يضم 4 روبوتات جراحية من طراز دافنشي شي وأجنحة عناية فائقة متصلة بالأقمار الصناعية للمتابعة الدقيقة.",
    internationalLounge: true,
    airportDistance: "35 Mins from Kempegowda Int'l Airport",
    featured: true,
  },
  {
    id: "apex-health-city",
    name: "Apex Multi-Specialty Health City",
    nameAr: "مدينة أبكس الطبية متعددة التخصصات",
    city: "Chennai",
    cityAr: "تشيناي",
    state: "Tamil Nadu",
    specialties: ["Transplant Medicine", "Cardiac Sciences", "Advanced IVF", "Gastroenterology"],
    specialtiesAr: ["زراعة الأعضاء", "علوم القلب", "أطفال الأنابيب", "أمراض الجهاز الهضمي"],
    accreditations: ["NABH Accredited", "JCI Accredited", "CAP Certified"],
    bedsCount: 900,
    surgeonsCount: 110,
    image: "https://images.unsplash.com/photo-1512678080530-7760d81faba6?auto=format&fit=crop&q=80&w=800",
    description: "Sprawling 50-acre medical city renowned for highest volume of living donor organ transplants in India, with private recovery villas for international families.",
    descriptionAr: "مدينة طبية متكاملة على مساحة 50 فداناً تشتهر بأعلى معدلات زراعة الأعضاء الناجحة وفلل فندقية خاصة لإقامة وتعافي عائلات المرضى الدوليين.",
    internationalLounge: true,
    airportDistance: "20 Mins from Chennai Int'l Airport",
    featured: false,
  },
];
...
export const PATIENT_CASE_STUDIES: PatientCaseStudy[] = [
  {
    ...
    hospital: "Meridian Heart Institute, New Delhi",
    timeline: [
      {
        stage: "Day 01 · Dubai",
        stageAr: "اليوم 01 · دبي",
        details: "Submitted angiography CD & reports on Vedara portal. Received detailed clinical assessment and second opinion within 16 hours.",
        detailsAr: "تقديم تقارير القسطرة عبر منصة فيدارا، والحصول على التقييم الطبي والرأي الثاني خلال 16 ساعة فقط.",
        location: "Dubai, UAE",
      },
      {
      ...
      {
        stage: "Day 06 · Arrival at Delhi T3",
        stageAr: "اليوم 06 · الوصول إلى نيودلهي",
        details: "VIP tarmac assistance, fast-track immigration with Medical Visa, and private chauffeur directly to Meridian Heart Institute.",
        detailsAr: "استقبال VIP وتسهيل إجراءات الدخول بالمطار، والنقل بسيارة خاصة مباشرة إلى المستشفى.",
        location: "New Delhi, India",
      },
      {
        stage: "Day 08 · Surgery & Procedure",
        stageAr: "اليوم 08 · الجراحة الدقيقة",
        details: "Successful 4-vessel off-pump bypass (CABG) + minimally invasive mitral valve repair. Extubated in under 4 hours.",
        detailsAr: "إجراء عملية مجازة الشريان التاجي على القلب النابض وترميم الصمام بنجاح تام وخروج من التنفس الاصطناعي خلال 4 ساعات.",
        location: "Meridian Heart Institute",
      },
      {
        stage: "Day 13 · Discharge & Healing Suite",
        stageAr: "اليوم 13 · الخروج وجناح التعافي",
        details: "Discharged to partner 5-star long-stay hotel suite with daily visits by Vedara physiotherapy nurse.",
        detailsAr: "الانتقال إلى الجناح الفندقي الفاخر المخصص للتعافي مع زيارة يومية لممرضة العلاج الطبيعي من فيدارا.",
        location: "New Delhi",
      },
      {
    ...
    quote: "I was deeply anxious about traveling for heart surgery. Having Aisha Khan coordinate every doctor meeting, hospital room, and airport transfer made it feel as comfortable as receiving treatment at home, but with world-leading surgical expertise.",
    quoteAr: "كنت قلقاً جداً من السفر لإجراء جراحة دقيقة بالقلب، لكن وجود منسقة الرعاية عائشة خان وتنسيقها لكل التفاصيل من المطار إلى غرفة المستشفى جعل التجربة في غاية السلاسة والراحة وكأننا بين أهلنا، وبأعلى كفاءة طبية عالمية.",
    stats: {
  ...
  },
  {
    ...
    hospital: "NovaCare Institute, Bengaluru",
    timeline: [
      {
        stage: "Week 1 · Nairobi",
        stageAr: "الأسبوع 1 · نيروبي",
        details: "Unable to walk for 6 months. Sent MRI scans to Vedara team and received surgical recommendation for endoscopic decompression.",
        detailsAr: "عدم القدرة على المشي لعدة أشهر. إرسال صور الرنين المغناطيسي لشبكة فيدارا وتلقي خطة الجراحة بالمنظار.",
        location: "Nairobi, Kenya",
      },
      {
        stage: "Week 2 · Bengaluru",
        stageAr: "الأسبوع 2 · بنغالورو",
        details: "Robotic minimally invasive spine fusion. Walking with support within 24 hours of surgery.",
        detailsAr: "إجراء جراحة تثبيت الفقرات بالروبوت والمنظار والتمكن من المشي بمساعدة خلال 24 ساعة فقط.",
        location: "NovaCare Bengaluru",
      },
      {
    ...
    quote: "After months of debilitating back pain in Nairobi, the team in Bengaluru gave me my life back. The cost was a fraction of European options and the hospital felt like a 5-star hotel.",
    quoteAr: "بعد أشهر من الألم والمعاناة في نيروبي، أعاد لي الفريق الطبي في بنغالورو القدرة على المشي والحياة الطبيعية. المستشفى كان في قمة الفخامة والتكلفة معقولة جداً.",
    stats: {
...
export const GLOBAL_DESKS: GlobalDesk[] = [
  ...
  },
  {
    ...
    countryAr: "كينيا وشرق أفريقيا",
    code: "KEN",
    flag: "🇰🇪",
    city: "Nairobi & Mombasa",
    phone: "+254 20 790 VEDARA",
    whatsapp: "+254701234567",
    coordinator: "David Ochieng",
    timeZone: "EAT (UTC+3)",
  },
  {
    country: "Nigeria & West Africa",
    countryAr: "نيجيريا وغرب أفريقيا",
    code: "NGA",
    flag: "🇳🇬",
    city: "Lagos & Abuja",
    phone: "+234 1 800 VEDARA",
    whatsapp: "+2348012345678",
    coordinator: "Emeka Obi",
    timeZone: "WAT (UTC+1)",
  },
  {
    country: "Bangladesh",
  ...
  },
  {
    ...
    countryAr: "أوزبكستان ودول آسيا الوسطى",
    code: "UZB",
    flag: "🇺🇿",
    city: "Tashkent",
    phone: "+998 71 800 VEDARA",
    whatsapp: "+998901234567",
    coordinator: "Nilufar Rahimova",
    timeZone: "UZT (UTC+5)",
  },
  {
    country: "United Kingdom & Europe",
    countryAr: "المملكة المتحدة وأوروبا",
    code: "GBR",
    flag: "🇬🇧",
    city: "London",
